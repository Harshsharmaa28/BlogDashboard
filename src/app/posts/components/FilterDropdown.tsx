...
export default function FilterDropdown({ users, onSelectUser }: FilterDropdownProps) {
  ...
  return (
    <div className="mb-4">
      <label htmlFor="user-filter" className="block mb-2 text-sm font-medium text-gray-700">
        Filter by User:
      </label>
      <select
        id="user-filter"
